...
namespace PatoRestaurant.Models
{
    ...
    public class Reservation
    {
        ...
        [Required(ErrorMessage = "Informe o número de {0}")]
        public byte Guests { get; set; }

        [Display(Name = "E-mail")]
        [StringLength(100, ErrorMessage = "O {0} deve possuir no máximo {1} caracteres")]
        [EmailAddress(ErrorMessage = "Informe um e-mail válido")] // Permite validar se o email é valido, se tem caracteristicas de email
        public string Email { get; set; }

        [Display(Name = "Data de Cadastro")]
        public DateTime CreatedDate { get; set; } = DateTime.Now; // Preenche a data atual sozinha
